...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>新闻管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='新闻管理 > 新闻列表'; ?>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" id="<?php echo ($vo["id"]); ?>">
                                ...
                                <td><a href="javascript:void(0);"  title="推荐" onclick="changeAttr(<?php echo ($vo["id"]); ?>,this)"><img src="../Public/Img/action_<?php echo ($vo["is_recommend"]); ?>.png" border="0"></a>
                                    &nbsp;&nbsp;
<!--                                    <a href="javascript:void(0);" title="推荐到手机" onclick="changePhoneStatus(<?php echo ($vo["id"]); ?>,this)"><img src="__PUBLIC__/Img/iphone-<?php echo ($vo["wap_display"]); ?>.png" border="0">-->
                                </td>
                                <td>[ <a href="__URL__/edit?id=<?php echo ($vo["id"]); ?>&do=copy">复制 </a> ][ <a href="__URL__/edit?id=<?php echo ($vo["id"]); ?>">编辑 </a> ] [ <a link="<?php echo U('Product/del/',array('id'=>$vo['id']));?>" href="javascript:void(0)" name="<?php echo ($vo["title"]); ?>" class="del">删除 </a> ]</td>
