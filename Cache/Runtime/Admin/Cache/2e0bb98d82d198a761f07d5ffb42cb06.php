...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <?php $addCss=""; $addJs=""; $currentNav ='新闻管理 > 添加编辑新闻'; ?>
                ...
                <div id="Right">
                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                <th width="100">新闻发布状态：</th>
                                <td><label><input type="radio" name="info[status]" value="0" <?php if($info["status"] == 0): ?>checked="checked"<?php endif; ?> /> 新闻审核状态</label> &nbsp; <label><input type="radio" name="info[status]" value="1" <?php if($info["status"] == 1): ?>checked="checked"<?php endif; ?> /> 新闻已发布状态</label> </td>
                            </tr>
                            <tr>
                                <th>新闻所属分类：</th>
                                <td>
...
<!--                            <tr>
                            ...
                            <tr>
                                <th>新闻图片：</th>
                                <td><input type="text" class="input" id="getImgUrl" size="40" name="info[image]" value="<?php echo ($info["image"]); ?>"/>
        ...
        <script type="text/javascript">
            $(function(){
                ...
                $("#checkNewsTitle").click(function(){
                    ...
                    $.getJSON("__URL__/checkProductTitle", { title:$("#title").val(),id:"<?php echo ($info["id"]); ?>"}, function(json){
