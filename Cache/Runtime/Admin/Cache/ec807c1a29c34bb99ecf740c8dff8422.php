...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>添加、编辑招聘-后台管理-<?php echo ($site["SITE_INFO"]["name"]); ?></title>
        <?php $addCss=""; $addJs=""; $currentNav ='招聘管理 > 添加编辑招聘'; ?>
                ...
                <div id="Right">
                    ...
                    <form>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
                            ...
                            <tr>
                                <th width="100">地点：</th>
                                <td><input id="addiss" type="text" class="input" size="60" name="info[addiss]" value="<?php echo ($info["addiss"]); ?>"/></td>
                            </tr>
                            <tr>
                                <th width="100">发布状态：</th>
                                <td><label><input type="radio" name="info[status]" value="1" <?php if($info["status"] == 1): ?>checked="checked"<?php endif; ?> /> 已发布状态</label>
                                    &nbsp;<label><input type="radio" name="info[status]" value="0" <?php if($info["status"] == 0): ?>checked="checked"<?php endif; ?> /> 审核状态</label>
                                    </td>
                            </tr>
                            <tr>
                                <th>所属分类：</th>
...
<!--                            <tr>
                            ...
                            <tr>
                                <th>任职资格：</th>
                                <td><textarea id="content2" class="" style="height: 300px; width:80%;" name="info[content2]"><?php echo ($info['content2']); ?></textarea></td>
                            </tr>
                        </table>
