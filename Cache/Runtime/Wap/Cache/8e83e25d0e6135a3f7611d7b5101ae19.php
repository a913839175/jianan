    ...
    <div class="contentbg">
        <div class="contenttop">
            <div class="contentbottom">
                <h1><?php echo (L("T_ABOUT_US")); ?></h1>
                <p>手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）手机版关于我们（中文）</p>
            </div>
        </div>
    </div>
</div>
