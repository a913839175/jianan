    ...
    <div class="contentbg">
        <div class="contenttop">
            <div class="contentbottom">
                ...
                <?php if(is_array($wap_p_list)): $i = 0; $__LIST__ = $wap_p_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><h3><?php echo ($vo["title"]); ?></h3>
                <div class="productimg"><img src="__UPLOAD__/product/<?php echo ($vo["image"]); ?>" width="274" height="106" alt="<?php echo ($vo["title"]); ?>" /></div>
                <p><?php echo ($vo["description"]); ?></p><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
    </div>
</div>
